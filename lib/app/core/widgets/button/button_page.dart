      ...
      child: ElevatedButton(
        ...
        child: Text(
          ...
          style: GoogleFonts.poppins(
              fontSize: 16, fontWeight: FontWeight.w900, color: kWhiteColor),
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: MaterialButton(
        ...
        color: type == RoundedButtonType.white ? Colors.white : primaryColor,
        textColor:
            type == RoundedButtonType.white ? primaryColor : Colors.white,
        height: 55,
        child: AutoSizeText(
          title,
          style:
